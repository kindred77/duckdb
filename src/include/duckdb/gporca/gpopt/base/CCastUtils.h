...
public:
	...
	static GP_BOOL FBinaryCoercibleCastedScId(CExpression *pexpr, CColRef *colref);

	// is the given expression a binary coercible cast of a scalar identifier
	static GP_BOOL FBinaryCoercibleCastedScId(CExpression *pexpr);

	static GP_BOOL FBinaryCoercibleCastedConst(CExpression *pexpr);
	...
	static GP_BOOL FBinaryCoercibleCast(CExpression *pexpr);

	// check whether the given expression is a cast of something
	static GP_BOOL FScalarCast(CExpression *pexpr);
