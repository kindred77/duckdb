...
// namespace gpdxl { class CDXLNode; }
...
// const CDXLNodeArray *cte_producers,
		...
		GP_ULONG ulHosts,		// number of hosts (data nodes) in the system
		GP_ULONG ulSessionId,	// session id used for logging and minidumps
		GP_ULONG ulCmdId,		// command id used for logging and minidumps
