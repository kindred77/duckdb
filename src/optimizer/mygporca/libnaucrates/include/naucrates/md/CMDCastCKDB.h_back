#ifndef GPMD_CMDCastCKDB_H
#define GPMD_CMDCastCKDB_H
...
//
//---------------------------------------------------------------------------
class CMDCastCKDB : public IMDCast
{
private:
	// private copy ctor
	CMDCastCKDB(const CMDCastCKDB &);
...
public:
	// ctor
	CMDCastCKDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname, IMDId *mdid_src,
