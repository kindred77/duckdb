#ifndef GPMD_CMDAggregateCKDB_H
#define GPMD_CMDAggregateCKDB_H
...
//
//---------------------------------------------------------------------------
class CMDAggregateCKDB : public IMDAggregate
{
	// memory pool
	CMemoryPool *m_mp;
	...
	// private copy ctor
	CMDAggregateCKDB(const CMDAggregateCKDB &);

public:
	// ctor
	CMDAggregateCKDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname,
