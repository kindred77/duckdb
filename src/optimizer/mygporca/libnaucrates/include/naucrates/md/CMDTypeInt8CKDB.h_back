#ifndef GPMD_CMDTypeInt8CKDB_H
#define GPMD_CMDTypeInt8CKDB_H
...
//
//---------------------------------------------------------------------------
class CMDTypeInt8CKDB : public IMDTypeInt8
{
	friend class CGPDBTypeHelper<CMDTypeInt8CKDB>;
...
private:
	...
	// private copy ctor
	CMDTypeInt8CKDB(const CMDTypeInt8CKDB &);

public:
	// ctor/dtor
	explicit CMDTypeInt8CKDB(CMemoryPool *mp);

	virtual ~CMDTypeInt8CKDB();
