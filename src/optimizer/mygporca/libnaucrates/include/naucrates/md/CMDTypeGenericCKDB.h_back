#ifndef GPMD_CMDTypeGenericCKDB_H
#define GPMD_CMDTypeGenericCKDB_H
...
//
//---------------------------------------------------------------------------
class CMDTypeGenericCKDB : public IMDTypeGeneric
{
	friend class CGPDBTypeHelper<CMDTypeGenericCKDB>;
...
private:
	...
	// private copy ctor
	CMDTypeGenericCKDB(const CMDTypeGenericCKDB &);
...
#endif	// !GPMD_CMDTypeGenericCKDB_H
