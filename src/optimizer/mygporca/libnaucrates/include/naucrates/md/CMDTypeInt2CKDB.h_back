...
#ifndef GPMD_CMDTypeInt2CKDB_H
#define GPMD_CMDTypeInt2CKDB_H
...
class CMDTypeInt2CKDB : public IMDTypeInt2
{
	friend class CGPDBTypeHelper<CMDTypeInt2CKDB>;
...
private:
	...
	// private copy ctor
	CMDTypeInt2CKDB(const CMDTypeInt2CKDB &);

public:
	// ctor
	explicit CMDTypeInt2CKDB(CMemoryPool *mp);

	// dtor
	virtual ~CMDTypeInt2CKDB();
