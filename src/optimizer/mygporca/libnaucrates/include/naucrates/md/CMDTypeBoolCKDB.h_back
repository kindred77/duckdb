#ifndef GPMD_CMDTypeBoolCKDB_H
#define GPMD_CMDTypeBoolCKDB_H
...
//
//---------------------------------------------------------------------------
class CMDTypeBoolCKDB : public IMDTypeBool
{
	friend class CGPDBTypeHelper<CMDTypeBoolCKDB>;
...
private:
	...
	// private copy ctor
	CMDTypeBoolCKDB(const CMDTypeBoolCKDB &);

public:
	// ctor
	explicit CMDTypeBoolCKDB(CMemoryPool *mp);

	// dtor
	virtual ~CMDTypeBoolCKDB();
