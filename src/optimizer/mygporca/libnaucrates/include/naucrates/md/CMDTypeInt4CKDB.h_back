#ifndef GPMD_CMDTypeInt4CKDB_H
#define GPMD_CMDTypeInt4CKDB_H
...
class CMDTypeInt4CKDB : public IMDTypeInt4
{
	friend class CGPDBTypeHelper<CMDTypeInt4CKDB>;
...
private:
	...
	// private copy ctor
	CMDTypeInt4CKDB(const CMDTypeInt4CKDB &);

public:
	// ctor
	explicit CMDTypeInt4CKDB(CMemoryPool *mp);

	//dtor
	virtual ~CMDTypeInt4CKDB();
