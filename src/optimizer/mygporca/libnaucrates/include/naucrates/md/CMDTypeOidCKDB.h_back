#ifndef GPMD_CMDTypeOidCKDB_H
#define GPMD_CMDTypeOidCKDB_H
...
class CMDTypeOidCKDB : public IMDTypeOid
{
	friend class CGPDBTypeHelper<CMDTypeOidCKDB>;
...
private:
	...
	// private copy ctor
	CMDTypeOidCKDB(const CMDTypeOidCKDB &);

public:
	// ctor/dtor
	explicit CMDTypeOidCKDB(CMemoryPool *mp);

	virtual ~CMDTypeOidCKDB();
