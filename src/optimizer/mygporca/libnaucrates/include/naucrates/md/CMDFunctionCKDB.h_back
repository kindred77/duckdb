#ifndef GPMD_CMDFunctionCKDB_H
#define GPMD_CMDFunctionCKDB_H
...
//
//---------------------------------------------------------------------------
class CMDFunctionCKDB : public IMDFunction
{
private:
	// memory pool
	CMemoryPool *m_mp;
	...
	// private copy ctor
	CMDFunctionCKDB(const CMDFunctionCKDB &);

public:
	// ctor/dtor
	CMDFunctionCKDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname,
